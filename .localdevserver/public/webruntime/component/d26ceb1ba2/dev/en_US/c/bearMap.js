Webruntime.moduleRegistry.define('c/bearMap', ['lwc', '@salesforce/i18n/locale', 'lightning/configProvider', '@salesforce/i18n/dir', 'lightning/navigation'], function (lwc, locale, configProvider, dir, navigation) { 'use strict';
    ...
    **/
    ...
    tmpl$5.stylesheetTokens = {
      hostAttribute: "lwc-bearMap_bearMap-host",
      shadowAttribute: "lwc-bearMap_bearMap"
    };
    ...
    class BearMap extends lwc.LightningElement {
      constructor(...args) {
        super(...args);
        this.mapMarkers = [];
        this.pageRef = void 0;
    ...
    lwc.registerDecorators(BearMap, {
      wire: {
        pageRef: {
    ...
    var bearMap = lwc.registerComponent(BearMap, {
      tmpl: _tmpl$6
    });
